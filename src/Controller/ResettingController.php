...
class ResettingController extends AbstractController
{
    ...
    public function request(Request $request, Mailer $mailer, TokenGeneratorInterface $tokenGenerator)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $user = $em->getRepository(Participant::class)->findOneBy(['mail' => $form->getData()['email']]);
            ...
            $mailer->sendMessage('projetsortir@laposte.net', $user->getMail(), 'renouvellement du mot de passe', $bodyMail);
     ...
     */
    public function resetting(Participant $user, $token, Request $request, UserPasswordEncoderInterface $passwordEncoder)
    {
